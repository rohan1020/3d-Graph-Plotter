...
static const char qt_meta_stringdata_MeshPainter[] = {
    "MeshPainter\0"
};
...
const QMetaObjectExtraData MeshPainter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MeshPainter::staticMetaObject = {
    { &QGLView::staticMetaObject, qt_meta_stringdata_MeshPainter,
      qt_meta_data_MeshPainter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MeshPainter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MeshPainter))
